...
main = Tk()
main.title("Lightweight Detection of Cross-VM Network Attacks in Simulated Cloud Environment")
...
def runGUI():
    ...
    font = ('times', 15, 'bold')
    title = Label(main, text='Lightweight Detection of Cross-VM Network Attacks in Simulated Cloud Environment')
